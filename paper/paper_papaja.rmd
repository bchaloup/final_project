...
# Results
 ...
 A two-way ANOVA was conducted to examin the effect of dwell times on fractal presentation directions. The results indicated a significant interaction between the effects of fractal direction and dwell time, *F*(2,31.01) = 42.68, *p*<0.05). Simple main effects showed that growth conditions showed significantly longer dwell times compared to the decay or random directional conditions. 
```{r, fig.show = "hold", out.height =  "25%",fig.align = 'left'}

knitr::include_graphics(here::here("presentation_images","group1.png"))

``` 

  The following graph plots the dwell times over the course of the study for participant group 1. Group 1 and 2 where counterbalanced in fractal presentation order but show similar trends of decreasing dwell times as image number increases or the task itself progresses. Decreases in dwell times over time are likely attributed to fatigue or waning attention as the participants lose focus over time.      
```{r, fig.show = "hold", out.height =  "25%",fig.align = 'left'}

knitr::include_graphics(here::here("presentation_images","ovr_dwell_time2.png"))
